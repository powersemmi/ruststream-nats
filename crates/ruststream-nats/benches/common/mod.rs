...
//! not, so two allocations per message of the batch scenario are ones a production service does
//! not make. The rest come once per batch, most of them from the in-process subscriber growing the
//! batch it assembles.
//!
