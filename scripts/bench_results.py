...
state, and the one-delivery run is the cold start. Either run keeps the section the other one
wrote.
...
FEATURES = "ruststream-nats default (none), ruststream macros,json"
