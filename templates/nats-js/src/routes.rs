...
//! to a concrete broker only when `main` mounts it. `confirm` carries its
//! `JetStreamConsumer` source from the decorator; the registration reuses that source as is. This
